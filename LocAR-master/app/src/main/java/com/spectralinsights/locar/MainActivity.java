...
import com.spectralinsights.locar.R;
...
public class MainActivity extends ListActivity{
    ...
    protected void onCreate( Bundle savedInstanceState ) {
        ...
        String Info = "Built by Hare Sudhan M";
        t.setText(Info);
    }
    ...
    protected void onListItemClick( ListView l, View v, int position, long id ) {
        ...
        for (int i= 0; i< activitiesToLaunch.size(); i++) {
            ...
            if (meta.categoryId.equals("5") && meta.sampleId==1) {
                activityClasses[i] = ("com.spectralinsights.locar.SampleCamContentFromNativeActivity");
            } else if (meta.categoryId.equals("8") && meta.sampleId==1) {
                activityClasses[i] = ("com.spectralinsights.locar.SampleFrontCamActivity");
            } else if (meta.categoryId.equals("9") && meta.sampleId==1) {
                activityClasses[i] = ("com.spectralinsights.locar.SamplePluginActivity");
            } else if (meta.categoryId.equals("9") && meta.sampleId==2) {
                activityClasses[i] = ("com.spectralinsights.locar.FaceDetectionPluginActivity");
            } else if (meta.categoryId.equals("9") && meta.sampleId==3) {
                activityClasses[i] = ("com.spectralinsights.locar.CustomCameraActivity");
            }
            else {
                activityClasses[i] = ("com.spectralinsights.locar.SampleCamActivity");
            }
        }
    ...
    {
        try {
            this.startActivity( new Intent( this, Class.forName( "com.spectralinsights.locar.utils.urllauncher.ARchitectUrlLauncherActivity" ) ) );
